    ...
    at = (function () {
      ...
      return (
        ...
        (t._slide = function (t, e) {
          ...
          if (
            ((o = t === M ? ((n = X), (i = z), U) : ((n = V), (i = G), B)), l && p(l).hasClass(Q))
          )
            this._isSliding = !1;
      ...
      return (
        ...
        (c._jQueryInterface = function (e) {
          return this.each(function () {
            ...
            if (
              (t || ((t = new c(this, "object" == typeof e ? e : null)), p(this).data(Te, t)),
              "string" == typeof e)
            ) {
        ...
        (i._jQueryInterface = function (n) {
          return this.each(function () {
            ...
            if (
              ...
              (t || ((t = new i(this, e)), p(this).data(gn, t)), "string" == typeof n)
            ) {
              if ("undefined" == typeof t[n]) throw new TypeError('No method named "' + n + '"');
              t[n]();
            }
      ...
      return (
        ...
        (i._jQueryInterface = function (n) {
          return this.each(function () {
            ...
            if (
              (t || !/dispose|hide/.test(n)) &&
              (t || ((t = new i(this, e)), p(this).data(Rn, t)), "string" == typeof n)
            ) {
              if ("undefined" == typeof t[n]) throw new TypeError('No method named "' + n + '"');
              t[n]();
            }
      ...
      return (
        ...
        (n._jQueryInterface = function (e) {
          return this.each(function () {
            ...
            if (
              (t || ((t = new n(this, "object" == typeof e && e)), p(this).data(Jn, t)),
              "string" == typeof e)
            ) {
              if ("undefined" == typeof t[e]) throw new TypeError('No method named "' + e + '"');
              t[e]();
        ...
        (i._jQueryInterface = function (n) {
          return this.each(function () {
            var t = p(this),
              e = t.data(xi);
            if (
              (e || ((e = new i(this, "object" == typeof n && n)), t.data(xi, e)),
              "string" == typeof n)
            ) {
              if ("undefined" == typeof e[n]) throw new TypeError('No method named "' + n + '"');
              e[n](this);
