        ...
        <section id="about">
          <div className="container">
            <header className="section-header">
              <h3>In The News</h3>
              <p>
                Find out what’s new with Indexial Solutions, our people and diverse operations. Read
                on the latest press releases &amp; announcements, news articles and insights to
                learn all that we’re innovating in the field of Technology.
              </p>
            </header>
            ...
            <div className="card-group">
              ...
              >
                <img className="card-img-top" src={Media} alt="Card cap" />
