      ...
      <section id="intro" className="clearfix">
        <div className="container">
          <div className="intro-img">
            <img src={HomeImg} height="1200" alt="Indexial" className="img-fluid" />
          </div>
          ...
          <div className="intro-info">
            ...
            <div>
              <a href="Under_Maintenance.html" className="btn-get-started scrollto">
                Get Started
              </a>
              ...
              <div className="col-lg-6 content order-lg-1 order-2">
                <div className="icon-box wow fadeInUp">
                  ...
                  <p className="description">
                    Stay in the flow of analysis. Share what you’ve discovered and watch the value
                    of your work multiply. We offer certified installation and consulting services
                    for the most popular server and cloud-based billing, accounting and practice
                    management software packages for law firms and small businesses.
                  </p>
                </div>
                ...
                <div className="icon-box wow fadeInUp" data-wow-delay="0.4s">
                  ...
                  <p className="description">
                    Our professional engineers are waiting to serve you. All of the skillful workers
                    are thirsty to provide you with the quality durable products.Choose to focus
                    your time, energy and conversation around people who inspire you, support you
                    and help you to grow you into your happiest, strongest, wisest self.
                  </p>
                </div>
              </div>
        ...
        <section id="services" className="section-bg">
          <div className="container">
            <header className="section-header">
              ...
              <p>
                We offer services with dedicated experts and best technologies that that can
                transfrom world to be a better place to live
              </p>
            </header>
            ...
            <div className="row">
              ...
              >
                <div className="box">
                  ...
                  <p className="description">
                    ...
                    for the Internet or an intranet. Web development can range from developing a
              ...
              <div className="col-md-6 col-lg-5 wow bounceInUp" data-wow-duration="1.4s">
                <div className="box">
                  ...
                  <p className="description">
                    User Interface Design is its compliment, the look and feel, the presentation and
                    interactivity of a product. But like UX, it is easily and often confused by the
                    industries that employ UI Designers. design or user interface engineering is the
                    design of user interfaces for machines and software <br />
                    <a href="Under_Maintenance.html">
                      {" "}
                      <button className="button button100">know More</button>
                    </a>
              ...
              >
                <div className="box">
                  <div className="icon">
                    "<i className="ion-android-options" style={{ color: "#3fcdc7" }}></i>
                  </div>
                  <h4 className="title">
                    <a href="#/">Embedded Design</a>
                  </h4>
                  <p className="description">
                    An embedded system is a programmed controlling and operating system with a
                    dedicated function within a larger mechanical or electrical system, often with
                    real-time computing constraints <br />
                    <a href="Under_Maintenance.html">
                      {" "}
                      <button className="button button100">know More</button>
                    </a>
              ...
              >
                <div className="box">
                  ...
                  <p className="description">
                    A comprehensive guide to app design. Developing a mobile application is a big
                    investment, and the fundamental stages of the project should be providing a
              ...
              >
                <div className="box">
                  <div className="icon">
                    <i className="ion-social-android-outline" style={{ color: "#d6ff22" }}></i>
                  </div>
                  <h4 className="title">
                  ...
                  <p className="description">
                    ...
                    for mobile devices, such as personal digital assistants, enterprise digital
              ...
              >
                <div className="box">
                  <div className="icon">
                    <i className="ion-ios-cloud-upload-outline" style={{ color: "#4680ff" }}></i>
                  </div>
                  <h4 className="title">
              ...
              >
                <div className="box">
                  <div className="icon">
                    <i className="ion-android-contract" style={{ color: "#d6ff22" }}></i>
                  </div>
                  <h4 className="title">
                    <a href="#/">Consulting </a>
                  </h4>
                  <p className="description">
                    ...
                    and opportunities: strategy, marketing, organization, technology,
              ...
              >
                <div className="box">
                  ...
                  <p className="description">
                    A good testing and QA services ensures to minimize the cost, mitigate risk,
                    augment user experience levels by offering a creative solutions to improve
                    product life cycle.
                    <br />
                    <a href="Under_Maintenance.html">
                      <button className="button button100">know More</button>
